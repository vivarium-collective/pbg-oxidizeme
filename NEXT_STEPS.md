...
- **Generate from natural language** — describe what you want; the dashboard writes a request file and prompts you to run `/pbg-viz <name>`, which scaffolds a new Visualization function into `pbg_oxidizeme/visualizations/` and commits it on a stage branch.
